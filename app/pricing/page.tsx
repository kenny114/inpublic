...
const shared = ["Standard and Story Mode", "Visualization intelligence", "Camera recording and voice commands", "Editable canvas and every export format", "Identical video quality", "No watermark"];
const plans = [
